...
const styles = StyleSheet.create({
  ...
  dueBadge: { backgroundColor: colors.surfaceSoft, borderColor: colors.line, borderRadius: 14, borderWidth: 1, color: colors.greenDark, fontSize: 12, fontWeight: "900", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 4 },
  ...
  metaChip: { backgroundColor: "#f6f1e6", borderColor: colors.line, borderRadius: 14, borderWidth: 1, color: colors.muted, fontSize: 12, fontWeight: "800", overflow: "hidden", paddingHorizontal: 8, paddingVertical: 4 },
