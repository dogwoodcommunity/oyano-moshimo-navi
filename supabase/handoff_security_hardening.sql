-- Harden Web-to-app handoff tokens for existing production databases.
-- Tokens are treated as one-time use in the Next.js API and are accepted only
-- for a short window from case_results.created_at.
