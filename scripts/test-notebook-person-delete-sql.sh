...
REGRESSION_CONTAINER_NAME="oyano-person-delete-${GITHUB_RUN_ID:-local}-$$"
...
run_sql supabase/notebook_person_delete.sql
run_sql supabase/notebook_person_delete_regression.sql

echo "Whole-person notebook deletion PostgreSQL regression: ok"
