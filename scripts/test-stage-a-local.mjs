...
const sourceTests = [
  ...
  "diary-unsaved-changes", "diary-continuity", "diary-follow-up", "provider-directory", "provider-directory-boundaries", "personal-data-infra", "backup-generation",
  ...
  "mobile-native-compile-safety", "mobile-android-apk",
