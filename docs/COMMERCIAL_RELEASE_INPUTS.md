...
| アカウント削除担当・代行者 | **主担当：代表取締役 池田哲也／代行者：池田知也** | 両名は2026-09-04に運営者確認。代行者の役職・内部連絡手段・別確認者・app_admin登録は未確定 |
| 障害対応責任者・代行者 | **主責任者：代表取締役 池田哲也／代行者：池田知也** | 両名と、代行者の責任範囲「主責任者不在時の連絡・初動判断の代行。本番操作は別途権限を持つ担当者が実施」は2026-09-04に運営者確認。代行者の役職、両名の内部連絡手段、アラート通知先、当番体制、各サービスの実行権限は未確認 |
