...
| 項目 | 確定値 | 完了根拠 |
| --- | --- | --- |
| サービス運営者の正式名称 | **要確定** | 登記・開業情報等と照合 |
| 個人情報管理責任者の氏名または役職 | **要確定** | 責任者承認 |
| 利用者向け問い合わせ先 | **要確定** | 実際に受信・返信できることを確認 |
...
| 環境変数 / 項目 | 確定する内容 | 状態 |
| --- | --- | --- |
| `LEGAL_BUSINESS_NAME` | 販売事業者の正式名称 | **要確定** |
| `LEGAL_RESPONSIBLE_PERSON` | 通信販売業務の責任者 | **要確定** |
| `LEGAL_ADDRESS` | 特商法表示に用いる所在地 | **要確定** |
| `LEGAL_PHONE` | 特商法表示に用いる電話番号 | **要確定** |
| `LEGAL_PHONE_HOURS` | 電話受付時間 | **要確定** |
| `LEGAL_CONTACT` | 問い合わせメールまたはフォームURL | **要確定** |
