...
| 問い合わせ受付時間・一次返信目標 | **メール受付：24時間／原則3営業日以内に返信** | 2026-09-04に運営者確認。公開前に担当体制を最終確認 |
| 利用規約の施行日 | **要確定** | 公開日と照合 |
...
| `LEGAL_CONTACT_RESPONSE_TARGET` | 問い合わせ受付時間・一次返信目標 | **メール受付：24時間／原則3営業日以内に返信（確定・本番環境への設定待ち）** |
